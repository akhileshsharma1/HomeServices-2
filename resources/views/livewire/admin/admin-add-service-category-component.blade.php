...
<link rel="stylesheet" href="{{asset('assets/css/addservicecategory.css')}}">
    <section class="content-central">
        <div class="content_info">
            <div class="paddings-mini">
                <div class="container">
                    <div class="row portfolioContainer">
                        <div class="col-md-8 profile1">
                            <div class="panel panel-default">
                                <div class="panel-heading">
                                    <div class="row">
                                        ...
                                        <div class="col-md-6">
                                            ...
                                            <link rel="stylesheet" href="{{asset('assets/css/contactus.css')}}">                </div>
                                    </div>
                                </div>
                                <div class="panel-body">
                                   ...
                                   <form class="form-horizontal" wire:submit.prevent="createNewCategory">
                                        ...
                                        <button type="submit" class="btn1 btn-success pull-right">Add category</button>
                                    </form>
                                </div>
                            </div>
                        </div>
